                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="country"  v-model="country" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                       ...
                       <br>
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12"><input type="text" class="form-control" v-model="cardNumber" name="car_number" value="" /></div>
                            </div>
                            <div class="form-group">
